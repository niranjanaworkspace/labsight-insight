    ...
    <div className="space-y-6">
      ...
      <GlassCard>
        ...
        <Button
          ...
          onClick={() => toast.success("Profile updated", { description: "Changes saved for this demo session." })}
        >
          Save changes
        </Button>
      </GlassCard>
      ...
      <GlassCard>
        ...
        <div className="mt-4 space-y-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <Switch checked={notify} onCheckedChange={setNotify} aria-label="Analysis notifications" />
          </div>
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0">
            ...
            <Switch checked={weekly} onCheckedChange={setWeekly} aria-label="Weekly trend summary" />
          </div>
          <div>
            <div className="flex items-center justify-between gap-4">
      ...
      <GlassCard>
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <Button
            variant="outline"
            onClick={() => toast.success("Export prepared", { description: "Your demo data bundle is ready." })}
          >
          ...
          <Button
            ...
            onClick={() => toast("Demo data cleared", { description: "Sample reports will reload on refresh." })}
          >
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              patterns and significant changes for review. It does not diagnose conditions or replace
              clinical judgment.
            </p>
          </div>
        </div>
